...
export function PageHero({ eyebrow, title, description, narrow = false }: PageHeroProps) {
  return (
    <section className="relative overflow-hidden bg-navy pt-32 pb-20 text-white">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_82%_18%,rgba(16,185,129,0.28),transparent_24%),radial-gradient(circle_at_10%_100%,rgba(30,41,59,0.9),transparent_34%),linear-gradient(115deg,#0f172a_0%,#101d32_55%,#0b2630_100%)]" />
      ...
      <div className="absolute right-[14%] top-40 h-3 w-3 rounded-full bg-emerald shadow-[0_0_0_12px_rgba(16,185,129,0.12)]" />
