...
export function PageHero({ eyebrow, title, description, narrow = false }: PageHeroProps) {
  return (
    <section className="relative overflow-hidden bg-navy pt-32 pb-20 text-white">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_82%_18%,rgba(217,155,127,0.32),transparent_24%),radial-gradient(circle_at_10%_100%,rgba(15,48,64,0.9),transparent_34%),linear-gradient(115deg,#0F3040_0%,#0F3040_55%,#464858_100%)]" />
      ...
      <div className="absolute right-[14%] top-40 h-3 w-3 rounded-full bg-emerald shadow-[0_0_0_12px_rgba(217,155,127,0.22)]" />
